...
public class EstoqueList extends JFrame {
    ...
    // Cores para a nova interface - Tema Índigo/Azul Escuro
    private static final Color PRIMARY_COLOR = new Color(63, 81, 181); // Índigo
    private static final Color SECONDARY_COLOR = new Color(26, 35, 126); // Índigo muito escuro
    private static final Color ACCENT_COLOR = new Color(121, 134, 203); // Azul médio
    private static final Color TEXT_COLOR = Color.WHITE;
    private static final Color BACKGROUND_COLOR = new Color(232, 234, 246); // Azul acinzentado claro
    private static final Color TABLE_HEADER_COLOR = new Color(57, 73, 171); // Índigo médio
    private static final Color TABLE_SELECTION_COLOR = new Color(197, 202, 233); // Azul seleção
    private static final Color BUTTON_HOVER_COLOR = new Color(48, 63, 159); // Índigo hover
