...
public class BombaListView extends JFrame {
    // Novo tema: Roxo/Rosa/Ciano
    private static final Color PRIMARY_COLOR = new Color(156, 39, 176); // Roxo
    private static final Color SECONDARY_COLOR = new Color(48, 48, 48); // Cinza escuro
    private static final Color ACCENT_COLOR = new Color(255, 64, 129); // Rosa vibrante
    private static final Color TEXT_COLOR = Color.WHITE;
    private static final Color ACTIVE_COLOR = new Color(0, 229, 255); // Ciano
    private static final Color BUTTON_HOVER_COLOR = new Color(186, 104, 200); // Roxo claro
