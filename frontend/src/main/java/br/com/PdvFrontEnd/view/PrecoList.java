...
public class PrecoList extends JFrame {
    ...
    // Cores para a nova interface - Tema Verde Água/Turquesa
    private static final Color PRIMARY_COLOR = new Color(0, 150, 136); // Verde água
    private static final Color SECONDARY_COLOR = new Color(38, 50, 56); // Cinza azulado escuro
    private static final Color ACCENT_COLOR = new Color(0, 188, 212); // Ciano claro
    private static final Color TEXT_COLOR = Color.WHITE;
    private static final Color BACKGROUND_COLOR = new Color(224, 247, 250); // Azul bem claro
    private static final Color TABLE_HEADER_COLOR = new Color(0, 121, 107); // Verde água escuro
    private static final Color TABLE_SELECTION_COLOR = new Color(128, 222, 234); // Ciano seleção
    private static final Color BUTTON_HOVER_COLOR = new Color(0, 172, 193); // Turquesa hover
