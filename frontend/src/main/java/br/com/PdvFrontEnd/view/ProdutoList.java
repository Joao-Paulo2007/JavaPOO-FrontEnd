...
public class ProdutoList extends JFrame {
    ...
    // Cores para a nova interface - Tema Roxo/Lilás
    private static final Color PRIMARY_COLOR = new Color(103, 58, 183); // Roxo
    private static final Color SECONDARY_COLOR = new Color(49, 27, 146); // Roxo escuro
    private static final Color ACCENT_COLOR = new Color(179, 136, 255); // Lilás claro
    private static final Color TEXT_COLOR = Color.WHITE;
    private static final Color BACKGROUND_COLOR = new Color(237, 231, 246); // Lilás bem claro
    private static final Color TABLE_HEADER_COLOR = new Color(94, 53, 177); // Roxo médio
    private static final Color TABLE_SELECTION_COLOR = new Color(209, 196, 233); // Lilás seleção
    private static final Color BUTTON_HOVER_COLOR = new Color(142, 36, 170); // Roxo hover
