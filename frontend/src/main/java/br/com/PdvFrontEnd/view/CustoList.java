...
public class CustoList extends JFrame {
    ...
    // Cores para a nova interface - Tema Vermelho/Rosa
    private static final Color PRIMARY_COLOR = new Color(244, 67, 54); // Vermelho
    private static final Color SECONDARY_COLOR = new Color(183, 28, 28); // Vermelho escuro
    private static final Color ACCENT_COLOR = new Color(255, 138, 128); // Rosa claro
    private static final Color TEXT_COLOR = Color.WHITE;
    private static final Color BACKGROUND_COLOR = new Color(255, 235, 238); // Rosa bem claro
    private static final Color TABLE_HEADER_COLOR = new Color(211, 47, 47); // Vermelho médio
    private static final Color TABLE_SELECTION_COLOR = new Color(255, 205, 210); // Rosa seleção
    private static final Color BUTTON_HOVER_COLOR = new Color(229, 57, 53); // Vermelho hover
