...
public class ContatoList extends JFrame {
    ...
    // Cores para a nova interface - Tema Verde Limão/Chartreuse
    private static final Color PRIMARY_COLOR = new Color(139, 195, 74); // Verde limão
    private static final Color SECONDARY_COLOR = new Color(51, 105, 30); // Verde escuro
    private static final Color ACCENT_COLOR = new Color(205, 220, 57); // Amarelo esverdeado
    private static final Color TEXT_COLOR = Color.WHITE;
    private static final Color BACKGROUND_COLOR = new Color(241, 248, 233); // Verde bem claro
    private static final Color TABLE_HEADER_COLOR = new Color(104, 159, 56); // Verde médio
    private static final Color TABLE_SELECTION_COLOR = new Color(220, 237, 200); // Verde seleção
    private static final Color BUTTON_HOVER_COLOR = new Color(124, 179, 66); // Verde hover
