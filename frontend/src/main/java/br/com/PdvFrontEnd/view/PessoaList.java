...
public class PessoaList extends JFrame {
    ...
    // Cores para a nova interface - Tema Laranja/Amarelo/Marrom
    private static final Color PRIMARY_COLOR = new Color(255, 152, 0); // Laranja vibrante
    private static final Color SECONDARY_COLOR = new Color(62, 39, 35); // Marrom escuro
    private static final Color ACCENT_COLOR = new Color(255, 193, 7); // Amarelo dourado
    private static final Color TEXT_COLOR = Color.WHITE;
    private static final Color BACKGROUND_COLOR = new Color(255, 248, 225); // Bege claro
    private static final Color TABLE_HEADER_COLOR = new Color(191, 87, 0); // Laranja escuro
    private static final Color TABLE_SELECTION_COLOR = new Color(255, 213, 79); // Amarelo seleção
    private static final Color BUTTON_HOVER_COLOR = new Color(230, 126, 34); // Laranja hover
