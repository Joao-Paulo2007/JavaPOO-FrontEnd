...
public class PessoaService {
    ...
    public void addPessoa(br.com.pdvfrontend.model.Pessoa pessoa) {
    }

    public void removePessoa(int selectedRow) {
    }

    public br.com.pdvfrontend.model.Pessoa[] listPessoas() {
        return null;
    }
}